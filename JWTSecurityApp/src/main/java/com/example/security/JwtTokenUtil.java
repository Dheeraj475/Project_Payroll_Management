...
import com.example.exception.UserAlreadyLoggedInException;
...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        if (activeTokens.containsKey(username) && !isTokenExpired(activeTokens.get(username))) {
            throw new UserAlreadyLoggedInException("User is already logged in with an active session.",activeTokens.get(username));
        }
